...
async function getRegisterRequest(req, res) {
    const fileName = "./public/register.html";
...
async function getTopRequest(req, res) {
    const fileName = "./public/top.html";
...
function isRegisterRequest(req) {
    return (req.url === "/register" && req.method === "GET");
}
function isTopRequest(req) {
...
async function postRegisterRequest(req, res) {
